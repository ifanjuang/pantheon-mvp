-- Immutable A/B proposal variants for one bounded Knowledge edit request.
-- Selecting a variant is a human review event; it does not apply the edit.
...
CREATE TABLE IF NOT EXISTS knowledge_edit_review_events (
    ...
    event_type TEXT NOT NULL CHECK (
        event_type IN ('variant_proposed', 'variant_selected', 'request_rejected', 'variant_applied')
    ),
    actor TEXT NOT NULL,
