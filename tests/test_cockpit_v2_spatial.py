...
@pytest.mark.parametrize("name", ["spatial_navigation.js", "v2_app_native.js"])
...
def test_v2_route_exposes_five_spaces_and_live_agency_project_collection() -> None:
    ...
    javascript = (COCKPIT / "v2_app_native.js").read_text(encoding="utf-8")
...
def test_v2_handoff_never_dispatches_or_starts_hermes_from_spatial_ui() -> None:
    ...
    app = (COCKPIT / "v2_app_native.js").read_text(encoding="utf-8")
