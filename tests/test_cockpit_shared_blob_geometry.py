...
def test_pantheon_affaires_pack_and_project_booster_share_one_geometry() -> None:
    ...
    assert "--effect-width: var(--effect-1-width, 75%)" in cards
    assert "--effect-width: var(--effect-2-width, 75%)" in cards
    assert "--effect-width: var(--effect-3-width, 75%)" in cards
    assert "--effect-height: var(--effect-1-height, 75%)" in cards
    assert "--effect-height: var(--effect-2-height, 75%)" in cards
    assert "--effect-height: var(--effect-3-height, 75%)" in cards
