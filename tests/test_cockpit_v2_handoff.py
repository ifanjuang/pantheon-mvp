...
def test_v2_handoff_separates_preview_issue_admission_revocation_and_runtime() -> None:
    ...
    for control in (
        ...
        'id="v2-handoff-revoke-reason"', 'id="v2-handoff-prepare"',
        'id="v2-handoff-submit" type="button" disabled',
        'id="v2-handoff-admit" type="button" disabled',
        'id="v2-handoff-revoke" type="button" disabled',
    ):
    ...
    assert '.v2-handoff-policy-grid' in css
    assert '.v2-handoff-actions--four' in css
